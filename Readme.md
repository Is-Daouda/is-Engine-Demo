...
- It comes with a **[Level Editor](https://github.com/Is-Daouda/is-Engine-Demo-Level-Editor)** that allows you to create your own levels and integrate them into the game.
...
- In order for CMake to detect your source files (.cpp) you must include them in the **app_src.cmake** file which is located in the **is-Engine-Demo/app/src/main/cmake** location.
...
#### All
3. Or open the **is-Engine-Demo/app/src/main** folder with **Solution Explorer**.
...
```
2. Or open the file **is-Engine-linux.cbp** in the location **is-Engine-Demo/app/src/main**.
...
#### Windows
- To change the icon of the application you must go to the location **is-Engine-Demo/app/src/main/env/windows** replace all the images **(Attention CMake uses the same resources).**

#### Linux
- To change the icon of the application you must go to the location **is-Engine-Demo/app/src/main/env/linux**.
...
----------------------------
- The source files of the project can be found in the **is-Engine-Demo/app/src/main/cpp** location.
