...
It integrates `Intro Screen`, `Main Menu`, `Level`, `Game Over` and `Congratulation Screen`. It comes with a **[Level Editor](https://github.com/Is-Daouda/is-Engine-Level-Editor)** that allows you to create your own levels and integrate them into the Demo.

![image](./images/demo_screen.png)

You can download the Android Demo **[here![image](https://github.com/Is-Daouda/is-Engine-Demo/blob/master/CodeBlocks/data/image/gui/icon.png)](./demo-apk/is-Engine-v2.2-demo.apk)**

## About the project components
- These scenes : `Intro`, `Main Menu`, `Game Over` and `Congratulation Screen` were created with the engine's standard tools
