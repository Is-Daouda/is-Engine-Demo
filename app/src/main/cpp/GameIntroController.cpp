#include "app_src/objects/gameintro/GameIntroController.h"
    ...
    m_playSnd(false)
{
    ...
    is::createRectangle(m_recChooseLanguage, sf::Vector2f(650.f, 224.f), sf::Color(0, 0, 0), 320.f, 240.f, true);
    ...
    is::setSFMLObjX_Y(m_sprGear[0], m_scene->getViewX()
                       ...
                       - 1.5f
#endif
                       , m_scene->getViewY() - 33.5f - Y_START);
    is::setSFMLObjX_Y(m_sprGear[1], m_scene->getViewX()
#if defined(IS_ENGINE_SDL_2)
                      + 1.f
#endif
                      , m_scene->getViewY() + 80.5f - Y_START);
    ...
    case 1:
        ...
        else
        {
            if (m_time < 55)
            {
                ...
                is::setSFMLObjTexRec(m_sprLogo, 91, 128, 600, 344);
            ...
            else
            {
                ...
                is::setSFMLObjY(m_recChooseLanguage, is::getSFMLObjY(m_recChooseLanguage) - 65.f);
                #endif // defined
                m_step++;
            }
        }
